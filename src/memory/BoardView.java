...
public class BoardView {
    ...
    public void displayBoard(Board board) {
        ...
        for (int i = 0; i < this.board.rowCount; i++) {
            ...
            Board.Location[] rowOfLocations = this.board.boardLocations[i];
    ...
    private void printRow(int rowNumber, Board.Location[] rowOfLocations) {
        
        // print contents of first column in the row
        String letter = " ";
        /* CHANGES NEEDED: This checks if the space is blank/removed 
        if (rowLocations[0].currentPlayer != null) {
            letter = rowLocations[0].currentPlayer.marker;
        }*/
        System.out.print("\n\t" + rowNumber + " | " + letter + " |");
